...
// Type: BlazeServer.Network.Send.NotifyPlayerClaimingReservation
...
internal class NotifyPlayerClaimingReservation : SendPacket
{
  private string name;
  private long gameid;
  ...
  public NotifyPlayerClaimingReservation(
    string name,
    long gameid,
    long playerid,
    long sid,
  ...
  protected internal override void make()
  {
    ...
    this.WriteStruct("PDAT", new List<Blaze.Tdf>()
    {
      ...
      (Blaze.Tdf) this.SetStr("ROLE", "soldier"),
      ...
      (Blaze.Tdf) this.SetTrippleVal("UGID", 30722L, 2L, this.playerid),
      (Blaze.Tdf) this.SetInt("UID\0", this.playerid)
    });
    this.CreatePacket((ushort) 4, (ushort) 25, 0, (ushort) 8192 /*0x2000*/, (ushort) 0);
  }
}
