...
// Type: BlazeServer.Network.Send.SendNotifyPlayerJoin
...
internal class SendNotifyPlayerJoin : SendPacket
{
  private string name;
  private long gameid;
