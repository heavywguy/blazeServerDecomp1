...
// Type: BlazeServer.SHandleComponent_7802
...
internal class SHandleComponent_7802
{
  public SHandleComponent_7802(
    GameManager player,
    Blaze.Packet p,
    out byte[] buf,
    ...
    try
    {
      ...
      switch (p.Command)
      {
        case 20:
          ...
          player.INIP = new GameManager.NETDATA();
          ...
          UserSessionExtendedDataUpdate extendedDataUpdate = new UserSessionExtendedDataUpdate((long) player.EXIP.IP, (long) player.EXIP.PORT, (long) player.INIP.IP, (long) player.INIP.PORT, 0L, player.GID, player.GID, false);
        ...
        case 35:
          ...
          break;
        default:
          SendError sendError2 = new SendError(p, 16386);
          sendError2.make();
